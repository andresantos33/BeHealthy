...
Color primary = const Color(0xFFA4CB30);
class Styles{
  static Color primaryColor = primary;
  static Color textColor = const Color(0xFFA4CB30);
  static Color bgColor = const Color(0xFFA4CB30);
  static Color orangeColor = const Color (0xFFA4CB30);
